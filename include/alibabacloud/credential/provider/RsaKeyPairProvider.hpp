...
class RsaKeyPairProvider : public ProviderBase,
                           std::enable_shared_from_this<RsaKeyPairProvider> {
public:
  RsaKeyPairProvider(std::shared_ptr<std::string> roleArn,
  ...
  RsaKeyPairProvider(const std::string &roleArn, const std::string &accessKeyId,
